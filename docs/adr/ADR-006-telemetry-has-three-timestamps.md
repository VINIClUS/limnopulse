...
Phase 2 must test delayed, duplicated, replayed, and out-of-order observations, resolve Deployment at event time, and prevent receive or ingest time from silently replacing event semantics.
