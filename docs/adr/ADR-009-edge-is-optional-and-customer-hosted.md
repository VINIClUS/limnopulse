...
Phase 9 may ship an edge contract only after authentication, local buffer/replay, upgrade, and compatibility acceptance tests pass and direct integrations remain operational.
